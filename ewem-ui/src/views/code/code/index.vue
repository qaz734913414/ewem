<template>
  <div class="app-container">
    <el-form :model="queryParams" ref="queryForm" :inline="true" v-show="showSearch" label-width="68px">
      <el-form-item label="码ID" prop="id">
        <el-input
    ...
    <el-table v-loading="loading" :data="codeList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="赋码规格" align="center" prop="spec" :formatter="specFormat" />
      <el-table-column label="码状态" align="center" prop="codeStatus" :formatter="codeStatusFormat" />
...
<script>
import { listCode, getCode, delCode, addCode, updateCode, exportCode } from "@/api/code/code";
...
export default {
  ...
  created() {
    this.getList();
    this.getDicts("ewem_code_spec").then(response => {
      this.specOptions = response.data;
    });
    this.getDicts("ewem_code_status").then(response => {
      this.codeStatusOptions = response.data;
    });
  },
  methods: {
    /** 查询码管理列表 */
    ...
    // 码状态字典翻译
    codeStatusFormat(row, column) {
      return this.selectDictLabel(this.codeStatusOptions, row.codeStatus);
    },
    // 取消按钮
    cancel() {
      this.open = false;
